		...
		<div class="container container-cc">
			...
			<div>
				<div id="char_creator_client" align="center">
					<object data="/goapi/getStaticAsset/?file=cc.swf&type=swf&subdir=<?php echo 'studio/' . $userStudio; ?>" type="application/x-shockwave-flash" id="char_creator" width="960" height="600">
						<param name="align" value="middle">
						<param name="allowScriptAccess" value="always">
						<param name="allowFullScreen" value="true">
						<param name="wmode" value="transparent">
						<param name="flashvars" value="">
						<param name="movie" value="/goapi/getStaticAsset/?file=cc.swf&type=swf&subdir=<?php echo 'studio/' . $userStudio; ?>"> </object>
				</div>
			</div>
			<script>
			...
			function characterSaved() {
				...
				window.location = 'https://ga.vyond.com/charactercreator/whiteboard';
			}
			</script>
		</div>
		<script>
