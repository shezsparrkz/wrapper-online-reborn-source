...
TemplateCC = (TemplateCC || function() {
    ...
    var b = "cc2";
    var a = {
        GA_TAGS: ["guy", "girl", "xmas", "thanksgiving", "scary", "scifi", "police", "history", "simple", "family", "office", "streetz", "famous", "chibi", "ninja"],
                ...
                success: function(f) {
                    f = jQuery.grep(f, function(j) {
                        ...
                        for (var g = 0; g < e.length; g++) {
                            if (jQuery.inArray("_category_" + e[g], j.tags) >= 0) {
                                return true
                            }
                        }
                        return false
